...
This requires that a suitable keystore with a valid certificate is provided. See the configuration details in the [provided template](https://lightstreamer.com/repo/distros/Lightstreamer_7_2_0.zip%23/Lightstreamer/docs/remote_adapter_robust_conf_template/adapters.xml).
...
See the configuration details in the [provided template](https://lightstreamer.com/repo/distros/Lightstreamer_7_2_0.zip%23/Lightstreamer/docs/remote_adapter_robust_conf_template/adapters.xml).
